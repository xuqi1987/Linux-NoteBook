...
#ifndef CV2X_HTTPCLIENT_H
#define CV2X_HTTPCLIENT_H
...
public:
    ...
    HttpMultiFormBody(const MapType &args,
                      const string &filePath,
                      const string &boundary,
                      uint32_t sliceSize = 4 * 1024)
    {
...
protected:
     ...
     * @return 是否继续
     */
    virtual bool onRedirectUrl(const string &url, bool temporary)
    { return true; };
