...
public:
     ...
     * @param hvTheta
     */
    static void CoordinateChange(double hvLon,double hvLat,double rvLon,double rvLat,double hvTheta,RelPosPoints_t &relPos);
     ...
     * @return
     */
    static RelPos RvRelPosition(RelPosPoints_t &rvPos,double dHvWidth,double dRvWidth, double dHvConf, double dRvConf);
