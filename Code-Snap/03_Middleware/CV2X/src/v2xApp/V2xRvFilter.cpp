...
{
    //long dis =V2xAlgorithmAdapter::GetDistance(pHv->u.hvbsm.pos.lon,pHv->u.hvbsm.pos.lat,pRv->u.rvbsm.pos.lon,pRv->u.rvbsm.pos.lat);
    //InfoL << "HV:"<<pHv->u.hvbsm.id <<" RV:"<< pRv->u.rvbsm.id <<" 两车距离: " << dis << "cm";
    static double lastdis = 0.0;
//
//    double newdis = V2xAlgorithmAdapter::GetDistance(pHv, pRv);
//
//    if (newdis != lastdis)
//    {
